...
class HMSThemeColors {
  static Color primaryDefault = Colors.deepPurple;
  static Color primaryBright = const Color(0xFF512DA8);
  static Color primaryDim = const Color(0xFF7E57C2);
  static Color primaryDisabled = const Color(0xFF4527A0);

  static Color onPrimaryHighEmphasis = const Color(0xFFFFFFFF);
  static Color onPrimaryMediumEmphasis = const Color(0xFFD1C4E9);
  static Color onPrimaryLowEmphasis =const Color(0xFFB39DDB);
  ...
  static Color borderPrimary = const Color(0xFF673AB7);
  ...
  static void resetLayoutColors() {
    primaryDefault = const Color(0xFF673AB7);
    primaryBright = const Color(0xFF512DA8);
    primaryDim = const Color(0xFF7E57C2);
    primaryDisabled = const Color(0xFF4527A0);

    onPrimaryHighEmphasis = const Color(0xFFFFFFFF);
    onPrimaryMediumEmphasis = const Color(0xFFD1C4E9);
    onPrimaryLowEmphasis =const Color(0xFFB39DDB);
